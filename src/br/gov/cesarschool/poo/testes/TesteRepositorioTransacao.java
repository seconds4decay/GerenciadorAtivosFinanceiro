...
public class TesteRepositorioTransacao extends TesteGeral {
    ...
    @Test
    public void testDAO00() throws IOException {
    ...
    public void testDAO03() throws IOException {
        ...
        EntidadeOperadora ea1 = new EntidadeOperadora(idCred, "EO7", true);
        EntidadeOperadora ea2 = new EntidadeOperadora(8, "EO8", false);
    ...
    public void testDAO04() throws IOException {
        ...
        EntidadeOperadora ea1 = new EntidadeOperadora(8, "EO7", true);
        EntidadeOperadora ea2 = new EntidadeOperadora(idDeb, "EO8", true);
        Transacao tr1 = new Transacao(ea1, ea2, null, titulo, 12.0, LocalDateTime.now());
